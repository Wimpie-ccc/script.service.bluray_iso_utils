...
Each directory containing these dummy videos need a "BIUinfo.xml". This file contains the relevent info to link the .BIUvideo.mp4 to the corresponding playlist in the iso file. [See example](https://raw.githubusercontent.com/Wimpie-ccc/helperfiles/master/BIUinfo.xml)
